...
const CF_VIDEOJS_STYLE = `
  ...
  .cf-video-player .vjs-volume-level { background: var(--cf-accent, #EF9F27); }
  ...
  .cf-video-player .vjs-button:hover > .vjs-icon-placeholder::before { color: var(--cf-accent, #EF9F27); }
  .cf-video-player .vjs-big-play-button {
    background: var(--cf-accent, #EF9F27); border: none; border-radius: 50%;
  ...
  .cf-video-player .vjs-big-play-button:focus {
    ...
    outline: 3px solid var(--cf-accent, #EF9F27); outline-offset: 2px;
  }
  ...
  [data-cf-mode="hc"] .cf-video-player .vjs-volume-level { background: #EF9F27; }
  [data-cf-mode="hc"] .cf-video-player .vjs-big-play-button { background: #EF9F27; border: 2px solid #FFFFFF; }
  ...
  .cf-video-player .vjs-button:focus {
    outline: var(--cf-focus-outline, 2px solid #EF9F27) !important; outline-offset: 2px;
  }
`
